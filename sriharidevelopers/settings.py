...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-srihari-developers-2024-production-key-change-me')
...
# Static files for production - use simpler storage to avoid manifest issues
